...
VALUES (NULL, '82198127000121', CURRENT_DATE(), CURRENT_DATE(), 'Enllite Solutions');
...
VALUES (NULL, '16248890935', CURRENT_DATE(), CURRENT_DATE(), 'primo@enllite.com', 'ADMIN', 'ROLE_ADMIN', NULL, NULL,
